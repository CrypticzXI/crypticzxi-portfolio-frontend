  ...
  return (
    <div className="bg-Background min-h-screen overflow-x-hidden">
      ...
      <Head>
        ...
        {Image0 ? <meta property="og:image" content={Image0}></meta> : <meta></meta>}
        <meta name="twitter:card" content="summary_large_image"></meta>
        {Image0 ? <meta id="image-src" name="twitter:image:src" content={Image0}></meta> : <meta></meta>}
        {Image0 ? <meta id="discord" name="twitter:image" content={Image0}></meta> : <meta></meta>}
      </Head>
